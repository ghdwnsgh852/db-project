  ...
  <div class="container">
    <div class="input-form-backgroud row">
      <div class="input-form col-md-12 mx-auto">
        <h4 class="mb-3">수업정보 수정</h4>
        <form class="validation-form" name="login" method="post" action ="/5025/update_class.php" novalidate>
        <?php
...
//send SQL
         ...
         ?>
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="text" name="instructor" class="form-control" id="instructor" placeholder="" value="<?php echo $instructor;?>">
              <div class="invalid-feedback">
                이름을  입력해주세요.
              </div>
            </div>
		...
		<?php endif; ?>
          ...
          <div class="mb-3">
            ...
            <textarea name="description"cols="50" class="form-control" rows="10" value=""  required><?php echo $description;?></textarea>
            <div class="invalid-feedback">
              설명을 입력해주세요.
            </div>
          </div>
          ...
          &nbsp;
          <form class="validation-form" name="del" method="post" action ="/5025/delete_class.php" novalidate>
          <?php
          echo "<input type=\"hidden\" id=\"id\" name=\"id\" value=".$cno.">";
          ?>
          <button class="btn btn-primary btn-lg btn-block" name = "delete" type="submit" id = "delete">삭제</button>
	  </form>
	  &nbsp;
	  <button class="btn btn-primary btn-lg btn-block" onClick="window.open('/5025/studentlist.php?cno=<?php echo $cno ?>','수강생목록','width=430,height=700,location=no,status=no,scrollbars=yes');" >수강생 목록</button>
          &nbsp;
