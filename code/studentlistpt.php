  ...
  <div class="container">
    <div class="input-form-backgroud row">
      <div class="input-form col-md-12 mx-auto">
        <h4 class="mb-3">PT 수강생 조회</h4>
        <form class="validation-form" name="login" method="post" action ="" novalidate>
        <div class="row">
            <div class="col-md-6 mb-3">
              <label for="ID">강사ID</label>
              <input type="text" name="ID" class="form-control" id="ID" placeholder=""value="<?php echo $_GET["mid"];?>" readonly>
	    <div class= "card card-body">
			...
			<tbody>
<?php        
            $sql ="select * from PT where TID='".$_GET["mid"]."'";
...
//send SQL
		...
		if($session_permission == "admin"){
			echo("<tr onclick = \"location.href='cancel_pt.php?tid=".$row[0]."&mid=".$row[1]."'\">");
